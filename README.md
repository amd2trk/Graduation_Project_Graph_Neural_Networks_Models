...
│   └── FNE/             # Nodes with Functional Name embeddings
└── ebd_map.csv          # Metadata mapping hashes to labels

🚀 Usage
This code is designed to run on Modal.
1. Setup
code
Bash
pip install modal
...
Comparative Analysis of Graph Neural Networks Architecture for Malware Detection
